...
%%% Version 1.3.2-neurips on 2026-04-27

%%%----------
%%% Imports

%%% Template specific - NeurIPS
...
% uncomment to show the colored diff
...
\newcommand{\EditMvAdd}[1]{\textcolor{yellow}{#1}}
\newcommand{\EditMvRm}[1]{\textcolor{yellow}{\sout{#1}}}

% uncomment to show the new version
% \newcommand{\EditAdd}[1]{#1}
% \newcommand{\EditRm}[1]{}
% \newcommand{\EditMod}[2]{#2}
% \newcommand{\EditMvAdd}[1]{#1}
% \newcommand{\EditMvRm}[1]{}
